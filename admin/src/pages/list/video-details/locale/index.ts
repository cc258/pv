const i18n = {
  'en-US': {
    ...
    'groupForm.title.video.info': 'Video Info',
    'groupForm.title.audio': 'Audio Parameters',
    'groupForm.title.explanation': 'Enter Explanation',

    'groupForm.form.label.video.name': 'Name',
    'groupForm.form.label.video.stars': 'Stars',
    'groupForm.form.label.video.year': 'Year',
    'groupForm.form.label.video.tags': 'Tags',
    'groupForm.form.label.video.categories': 'Categories',
    'groupForm.form.label.video.comment': 'Comment',
    'groupForm.form.label.video.cover': 'Cover',
    'groupForm.form.label.video.link': 'Link',
  ...
  'zh-CN': {
    ...
    'groupForm.title.video.info': '视频信息',
    'groupForm.title.audio': '音频参数',
    'groupForm.title.explanation': '填写说明',

    'groupForm.form.label.video.name': '标题',
    'groupForm.form.label.video.stars': '星级',
    'groupForm.form.label.video.year': '年份',
    'groupForm.form.label.video.tags': '标签',
    'groupForm.form.label.video.categories': '分类',
    'groupForm.form.label.video.comment': '留言',
    'groupForm.form.label.video.cover': '封面',
    'groupForm.form.label.video.link': '链接',
