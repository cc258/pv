const i18n = {
  'en-US': {
    ...
    'searchTable.columns.stars': 'stars',
    'searchTable.columns.year': 'year',
    'searchTable.columns.tags': 'tags',
    'searchTable.columns.categories': 'categories',
    ...
    'searchTable.columns.operations.delete.success': 'Delete Success!',
    'searchTable.columns.operations.delete.failed': 'Delete Failed!',
  ...
  'zh-CN': {
    ...
    'searchTable.columns.stars': '星级',
    'searchTable.columns.year': '上映时间',
    'searchTable.columns.tags': '标签',
    'searchTable.columns.categories': '分类',
    ...
    'searchTable.columns.operations.delete.success': '删除成功!',
    'searchTable.columns.operations.delete.failed': '删除失败!',
