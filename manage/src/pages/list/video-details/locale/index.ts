const i18n = {
  'en-US': {
    ...
    'basicProfile.title.info': 'Info',
    'basicProfile.title.year': 'Year',
    'basicProfile.title.tags': 'Tags',
    'basicProfile.title.stars': 'Stars',
    'basicProfile.title.categories': 'Categories',
    'basicProfile.title.cover': 'Cover',
    'basicProfile.title.link': 'Link',
  ...
  'zh-CN': {
    ...
    'basicProfile.title.info': '视频信息',
    'basicProfile.title.year': '时间',
    'basicProfile.title.tags': '标签',
    'basicProfile.title.stars': '星级',
    'basicProfile.title.categories': '分类',
    'basicProfile.title.cover': '封面',
    'basicProfile.title.link': '链接',
